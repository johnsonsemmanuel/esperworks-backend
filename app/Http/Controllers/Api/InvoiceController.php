...
class InvoiceController extends Controller
{
    ...
    public function store(Request $request, Business $business, InvoiceService $service)
    {
        $request->validate([
            ...
            'use_ghana_tax' => 'nullable|boolean',
            'nhil_rate' => 'nullable|numeric|min:0|max:100',
            'getfund_rate' => 'nullable|numeric|min:0|max:100',
            'covid_levy_rate' => 'nullable|numeric|min:0|max:100',
